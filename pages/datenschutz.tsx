	...
	return (
		<Page title="Datenschutz">
			<div className="container xl:max-w-6xl mx-auto px-4 text-base text-gray-900 datenschutz-container">
				...
				<p>
					Mit Hilfe von Mailjet ist es uns möglich, unsere Newsletter-Kampagnen
					zu analysieren. So können wir z.B. sehen, ob eine Newsletter-Nachricht
					geöffnet wurde und welche Links ggf. angeklickt wurden. Auf diese
					Weise können wir u.a. feststellen, welche Links besonders oft
					angeklickt wurden.
				</p>
				<p>
					...
					können so z.B. erkennen, ob Sie nach dem Anklicken des Newsletters
				...
				<p>
					...
					sich die Newsletterempfänger z.B. nach Alter, Geschlecht oder Wohnort
