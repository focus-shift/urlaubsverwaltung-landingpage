...
export default function Datenschutz() {
	return (
		<Page title="Datenschutz">
			<div className="container xl:max-w-6xl mx-auto px-4 text-base text-gray-900 datenschutz-container">
				<div className="xl:max-w-xl">
					...
					<p>
						...
						Anbieter ist die Mailjet SAS (Global HQ) Büro- und Postadresse
						Paris:
					</p>
					<address>
						13-13 bis
					...
					<p>
						...
						Newsletterbezugs eingegeben Daten werden auf den Servern von Mailjet
						in Deutschland gespeichert.
					</p>
					<p>
						Wenn Sie keine Analyse durch Mailjet wollen, müssen Sie den
					...
					<p>
						...
						Newsletter-Kampagnen zu analysieren. So können wir z.B. sehen, ob
						eine Newsletter-Nachricht geöffnet wurde und welche Links ggf.
						angeklickt wurden. Auf diese Weise können wir u.a. feststellen,
						welche Links besonders oft angeklickt wurden.
					</p>
					<p>
						Außerdem können wir erkennen, ob nach dem Öffnen/ Anklicken
						bestimmte vorher definierte Aktionen durchgeführt wurden
					...
					<p>
						...
						verschiedener Kategorien zu unterteilen ("clustern"). Dabei lassen
						sich die Newsletterempfänger z.B. nach Alter, Geschlecht oder
						Wohnort unterteilen. Auf diese Weise lassen sich die Newsletter
						besser an die jeweiligen Zielgruppen anpassen.
					</p>
					<p>
						Ausführliche Informationen zu den Funktionen von Mailjet entnehmen
						Sie folgendem Link:
						<a
