	...
	return (
		<Page title="Datenschutz">
			<div className="container xl:max-w-6xl mx-auto px-4 text-base text-gray-900 datenschutz-container">
				...
				<p>
					MailChimp hat ein sog. Data-Processing-Agreement in seine AGBs
					aufgenommen, in dem sich MailChimp verpflichtet, die Daten unserer
					Kunden zu schützen und sie nicht an Dritte weiterzugeben.
				</p>
				<p>
					Das Data-Processing-Agreement kann online eingesehen werden:
					<a
