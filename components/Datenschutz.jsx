...
import DatenschutzBetaphase from "../md/datenschutz-beta.mdx";

const mdxComponents = {
	h1: props => <h2 {...props}></h2>,
	h2: props => <h3 {...props}></h3>,
	h3: props => <h4 {...props}></h4>,
	h4: props => <h5 {...props}></h5>,
	h5: props => <h6 {...props}></h6>,
};

export default function Datenschutz() {
	return (
		<React.Fragment>
			<h1 className="mt-6 mb-6 text-3xl">Datenschutz</h1>
			<div>
				<ul className="list-disc list-inside">
					<li>
						<a href="#dateschutzerklaerung" className="underline">
							Datenschutz Webseite
						</a>
					</li>
					<li>
						<a href="#dateschutzerklaerung-betaphase" className="underline">
							Datenschutz Urlaubsverwaltung Beta-Phase
						</a>
					</li>
				</ul>
			</div>
			<hr />
			<div className="mb-16 datenschutz-container">
				<h2 id="dateschutzerklaerung">Datenschutzerklärung Webseite</h2>
				<DatenschutzLandingpage />
			</div>
			<div className="datenschutz-container">
				<h2 id="dateschutzerklaerung-betaphase">
					Datenschutzerklärung für die Urlaubsverwaltung Beta-Phase
				</h2>
				<DatenschutzBetaphase components={mdxComponents} />
			</div>
		</React.Fragment>
	);
}

function DatenschutzLandingpage() {
	return (
		<React.Fragment>
			...
			<h3 id="newsletter">4. Newsletter</h3>
			...
			<p>
				...
				ist die Mailjet SAS (Global HQ) Büro- und Postadresse Paris:
			</p>
			<address>
				13-13 bis
				<br />
				rue de l&rsquo;Aubrac
				<br />
				75012 Paris
				<br />
				France
			...
			<p>
				Mailjet ist ein Dienst, mit dem u.a. der Versand von Newslettern
				organisiert und analysiert werden kann. Die von Ihnen zum Zwecke des
				Newsletterbezugs eingegeben Daten werden auf den Servern von Mailjet in
			...
			<p>
				<strong>Datenanalyse durch Mailjet</strong>
			</p>
			<p>
				Mit Hilfe von Mailjet ist es uns möglich, unsere Newsletter-Kampagnen zu
				analysieren. So können wir z.B. sehen, ob eine Newsletter-Nachricht
				geöffnet wurde und welche Links ggf. angeklickt wurden. Auf diese Weise
				können wir u.a. feststellen, welche Links besonders oft angeklickt
				wurden.
			</p>
			<p>
				Außerdem können wir erkennen, ob nach dem Öffnen/ Anklicken bestimmte
			...
			<p>
				Mailjet ermöglicht es uns auch, die Newsletter-Empfänger anhand
				verschiedener Kategorien zu unterteilen ("clustern"). Dabei lassen sich
			...
			<p>
				Wir haben mit MailJet einen Vertrag zur Auftragsverarbeitung
				abgeschlossen und setzen die strengen Vorgaben der deutschen
				Datenschutzbehörden bei der Nutzung von MailJet vollständig um.
			</p>
